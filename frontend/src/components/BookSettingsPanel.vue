<template>
  <aside class="book-settings-panel" :class="{ open: panelOpen }">
    <div class="book-settings-toggle">
      <summary class="book-settings-summary" @click="panelOpen = !panelOpen">Book Settings</summary>
    </div>
